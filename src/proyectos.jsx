...
function Proyectos() {
  ...
  return (
    <div
      className="container mx-auto w-10/12  md:w-7/12 mt-32  "
      id="proyectos"
    >
      <div className="" style={{ alignContent: "stretch" }}>
        <h1 className="text-center text-4xl font-extrabold mt-10 mb-5">
        ...
        {dataproyectos.map((proyecto, index) => (
          <motion.div
            ...
            key={index}
            className={`grid grid-cols-1 md:grid-cols-6 md:gap-8 md:p-10`}
            onMouseEnter={() => setHoveredIndex(index)}
          >
            <div
              className={`col-span-1 md:col-span-4 py-8 px-1 pr-10 self-center  md:text-left ${
            ...
            >
              ...
              <a
                className="bg-gray-900 text-white dark:bg-purple-900 dark:text-white py-2 px-4 m-4 rounded-xl inline-block z-50 relative text-xl"
                href={proyecto.url}
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => console.log('URL:', proyecto.url)}
              >
            ...
            <div
              className={`col-span-1 mb-28 md:mb-0 md:p-2 md:col-span-2 ${
            ...
            >
              ...
              >
               ...
               <div className="flex justify-center gap-4 mt-10">
                {Object.entries(proyecto.tecnologias).map(
                  ([tecnologia, ruta]) => (
                    <Tooltip
                      showArrow={true}
                      color={"primary"}
                    ...
                    >
                      <img
                        ...
                        className={`
                                        ...
                                        ${
                                          tecnologia === "FIGMA"
                                            ? "tecnologia-icono-grande"
                                            : ""
                                        } ,
                                        ${
                                          tecnologia === "PHP"
                                            ? "tecnologia-icono-small"
                                            : ""
                                        } ,
                                        ${
                                          tecnologia === "MYSQL"
