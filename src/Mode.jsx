...
function Mode() {
    ...
    return (
        ...
        <div>
            ...
            <div className='flechaarriba fill-purple-700 transition duration-700 ease-in-out  hover:fill-gray dark:hover:fill-white'>
                <a className='fill-purple-700 transition duration-700 ease-in-out hover:fill-gray dark:hover:fill-white' href="#inicio">
                <svg xmlns="http://www.w3.org/2000/svg" width="84" height="84" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-up"><path d="m18 15-6-6-6 6"/></svg>
                </a>
            </div>
            ...
            className='socialmedia md:bg-gray-900   md:dark:bg-purple-900'>
                ...
                <ul>
                    ...
                    <a  href="mailto:axelemoncada@gmail.com">
                    ...
                    <li  className=' transition duration-300 ease-in-out hover:scale-110'>
                        <a href="https://www.linkedin.com/in/axel-moncada/" target='blank'>
