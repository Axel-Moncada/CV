            ...
            <div className="max-w-screen-xl mx-auto">
                ...
                <div className="grid grid-cols-8 gap-8 p-10 ">
                    <div className=" col-span-4">
                        <Card className=" bg-white/10 text-zinc-1000 h-full  hover:-translate-y-1 hover:scale-102  duration-600 glass justify-center items-center">
                            <CardHeader className=" flex-col items-start px-10 pt-10">
                                <h2 className="text-3xl font-bold">Hoobies </h2>
                            </CardHeader>
                    ...
                    <div className=" col-span-2">
                        <Card className=" bg-white/10 text-zinc-1000 h-full  hover:-translate-y-1 hover:scale-102  duration-600 glass justify-center items-center axelphoto">
                ...
                <div className="grid grid-cols-8 gap-8 p-10 pt-1">
                    ...
                    <div className=" col-span-4">
                        <Card className=" bg-white/10 text-zinc-1000 h-full  hover:-translate-y-1 hover:scale-102  duration-600 glass justify-center items-center map">
                            <video
                                autoPlay
                                loop
                                muted
                    ...
                    <div className=" col-span-2">
                        ...
                        <div className=" pb-10 aling-center items-center absolute  ">
                        <Card className=" bg-white/10 text-zinc-1000 h-full  glass justify-center items-center p-3">
                            <div className="flex flex-row gap-6 items-center">
                                <div className='hover:-translate-y-1 hover:scale-105 duration-700 items-center ml-1'>
                                    <img src={contacticon} alt="" width={60} />
                                </div>
                            ...
                            <div className='bg-black w-100 p-3 rounded-full flex flex-row gap-12 mt-2'>
