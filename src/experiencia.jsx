...
return(
    <div className="max-w-screen-xl mx-auto">
            ...
            <div className="grid grid-cols-1 m-10 mb-24 md:m-0 md:grid-cols-6 md:gap-8 md:p-10 md:mb-0 ">
                ...
                <div className="col-span-4">
                    <Card className="py-4 px-4  md:px-10 bg-white/10 text-zinc-1000 h-full self-center  hover:-translate-y-1 hover:scale-102  duration-600 glass">
            ...
            <div className="grid grid-cols-1 m-10 mb-24 md:m-0 md:grid-cols-6 md:gap-8 md:p-10 md:mb-0 ">
                <div className=" col-span-4 order-1 md:order-first">
                <Card className="py-4 px-4  md:px-10 bg-white/10 text-zinc-1000 h-full self-center  hover:-translate-y-1 hover:scale-102  duration-600 glass">
                        <CardHeader className=" flex-col items-start mb-3">
